...
- Creality Cloud https://www.crealitycloud.com/it/model-detail/6aae7192f052c066aeb8dd96 — listing complete (CC0, 20 tags, 37 files, docs) but rejected by moderation: the cover must be a real photo of the print. Creality has no drafts: the rejected listing stays private and editable, which serves as the draft. Edit it from the profile (3D model › ⋯ › Edit), add the photo as cover, set the name to "Primo open source humanoid robot", resubmit. Not linked publicly until approved
- MakerOnline https://www.makeronline.com/en/model/primo%20open%20source%20humanoid/331171.html
- MakerWorld https://makerworld.com/it/@RiverFamily — draft complete (title, Robotica, 13 tags, covers 4:3 and 3:4, 4 images, STL pack as raw files, ankle-gimbal print profile, CC0) rejected once by the automatic check (no real photo), now kept as a draft (3D models › Drafts, draft 9688828). From its Edit page add a photo of a printed part to the model images and to the print profile, drag `primo-30s.mp4` into the model video slot (it refuses scripted uploads), publish
