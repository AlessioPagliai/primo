...
The design is developed together with AI agents. These files let an agent — or a person — continue the work without redoing it. Entry point: [AGENTS.md](../../AGENTS.md).

- [ai-memory.md](ai-memory.md) — the raw working memory, source of truth for every decision, with dates, sources and open doubts. Newest blocks are at the top; older sections below are marked when superseded. Read this first.
