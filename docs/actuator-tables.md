...
| AK70-9 V3.0 | 9:1 | 29 | 8.5 | **Ø89×49** | 540 g | ✅ QDD | ankle roll, shoulder, elbow (NB: Ø89 = same as RS06 Ø88, NOT Ø70!) |
| **AKE90-8** | 8:1 | **170** | 55 | **Ø107.5×43.5** (1.4 kg, 121 Nm/kg) | 1.4 kg | ✅ QDD | **LEGS: hip pitch/roll, knee** (NB: Ø107.5 ~ same as RS04, NOT Ø90) |
| AKH70-16 | 16:1 | 85 | 26 | Ø70 hollow | — | ⚠️ semi | (compact-strong alt) |
| AK45-36 | 36:1 | 24 | 8 | **Ø55×54** | 340 g | ❌ stiff | EVAL+REJECTED: slim (Ø55) but 36:1 closes futureproofing (force/compliance/dynamics), WORST on the ankle (contact joint). See note. |
| AK80-64 | 64:1 | 120 | 48 | **Ø98×61.9** | 850 g | ❌ stiff | NOT smaller than RS04 (Ø98 vs Ø110); stiff -> useless on the legs |
| AK40-10 | 10:1 | 4.1 | 1.3 | **Ø53×37** | 185 g | ✅ QDD | neck (but RS05 Ø46 is smaller) |

**DECISION 2026-06-21 (CubeMars reopening closed): EVERYTHING STAYS QDD, no 36:1.** The user reopened the question for the AK45-36 36:1 (Ø55 vs RS06 Ø88 = slimmer arms/ankle). HONEST VERDICT after 3 questions from the user: (1) QDD is more FUTUREPROOF - 36:1 closes FOREVER force/impedance control + compliance + impact tolerance on that joint (a hardware life sentence, not upgradeable in software). (2) 36:1 is WORST on the ANKLE (contact joint, wants compliance the most) -> keep the ankle QDD. (3) On the ARMS 36:1 is fine ONLY for TODAY's position-based manipulation (ACT/diffusion), but it kills future contact-rich/compliant manipulation. Since the user cares about futureproofing/smart control -> **ALL QDD, AK45-36 REJECTED**. Chunky arms/ankle (Ø88) = cosmetic price + ~2.5 kg, does NOT limit capability; 36:1 does. The RobStride map locked earlier STAYS valid (or CubeMars-QDD AKE90 for stronger legs, 170 vs 120 Nm). NB: the AI had over-sold the AK45-36 in the previous turn, the user rightly corrected it.
